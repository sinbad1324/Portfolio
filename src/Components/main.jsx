...
export default function Main() {
    ...
    return (<main className=" z-0 rootMain row-start-2 row-end-3 ">
            ...
            <div className=" w-full h-full lg:h-28 lg:pl-56  lg:top-[40%] relative flex flex-col lg:flex-row justify-center lg:justify-start items-center gap-10   " >
                ...
                <div className="text-l-12   pl-5 md:pl-0   font-extrabold flex flex-col justify-center items-center lg:items-start gap-4 ">
                    ...
                    <div className="h-10 flex flex-row  d-TextShadow">
                        <h2 className="md:text-5xl text-2xl   text-l-vert-11  dark:text-d-vert-12 " ref={textEditorRef} ></h2>
                        <div className="md:text-5xl text-2xl text-l-blue-12 dark:text-d-blue-12 ">|</div>
                    </div>
                </div>
            </div>
        </div>

        <div ref={About} className=" bg-transparent w-full h-full row-start-2 row-end-3 flex md:flex-row  md:justify-between justify-center  items-center  md:items-start flex-col-reverse " >
            <div className="md:w-[40vw] w-full flex  justify-center  items-center ">
                <div className="h-auto md:rounded-xl rounded-md max-h-[700px]  brushmask md:w-[35vw]  w-[70vw] md:mt-0 mt-10 bg-transparent    shadow-md " >
                    <img className="   object-top object-cover bg-transparent max-h-[700px] w-full " src="https://wallpapercave.com/wp/wp9023490.jpg" alt="" />
                </div>
            </div>
            <div className="md:h-auto  md:max-h-[700px] md:w-[55vw]  w-full max-h-[1000px]    bg-transparent pr-6 p-4 overflow-hidden   rounded-lg  flex flex-col   justify-start items-start lg:gap-6  gap-2   " >
                ...
                <div className="w-full md:pr-8  h-fit  flex items-center justify-center  md:items-end  md:justify-end">
                    <a id={navEN[1]} className="active:animate-click hover:scale-110 hover:rounded-xl ease-in duration-75  transition-all  cursor-pointer w-24 h-12 flex justify-center items-center rounded-lg  bg-l-blue-7 dark:bg-d-blue-4 text-xl text-l-blue-12 dark:text-d-blue-12 border  border-d-blue-3 dark:border-d-blue-10 ">
                        MyCV
                    </a>
                </div>
            </div>
        ...
        <div ref={About} className=" bg-transparent w-full h-full row-start-3 row-end-4 flex md:flex-row-reverse  md:justify-between justify-center  items-center  md:items-start flex-col-reverse " >
            ...
            <div className="md:w-[50vw] w-full flex  justify-center  items-center ">
                <div className="ml-5 h-auto md:rounded-xl rounded-md max-h-[700px]   w-full   md:mt-0  mr-10 mt-10 bg-transparent  shadow-md " >
                    ...
                    <video className="rounded-lg w-full h-full" autoPlay muted controls>
                        <source src="https://i.gyazo.com/a67b13209d916717cd1fe5fed607e937.mp4" type="video/mp4" />
                    </video>
            ...
            <div className="md:h-auto  md:max-h-[700px] md:w-[50vw]  w-full max-h-[1000px]    bg-transparent pr-6 p-4 overflow-hidden   rounded-lg  flex flex-col justify-start items-start lg:gap-6  gap-2   " >
                <div className="w-full h-fit flex flex-row justify-center items-center md:justify-start">
                    <div id={navEN[2]} className=" hover:scale-110 transition-all ease-in duration-75  cursor-pointer w-24 h-12 flex justify-center items-center rounded-full  bg-l-vert-7 dark:bg-d-vert-7 text-xl text-l-vert-12 dark:text-d-vert-12 border  border-d-vert-3 dark:border-d-vert-10 ">
                        {navEN[2]}.
                    </div>
                </div>
                <div className="w-full h-fit">
                    <ul className="w-full flex flex-row md:justify-end justify-center items-center gap-6">
                        {[1, 2, 3].map((number) => {
                            return (
                                <li key={number}>
                                    <button className="active:animate-click hover:scale-110 hover:rounded-xl ease-in duration-75  transition-all  cursor-pointer w-14 h-12 flex justify-center items-center rounded-lg  bg-l-blue-5 hover:bg-l-blue-7  dark:bg-d-blue-3 dark:hover:bg-d-blue-4 text-xl text-l-blue-12 dark:text-d-blue-12 border  border-d-blue-3 dark:border-d-blue-10 ">
                                        P.{number}
                                    </button>
                                </li>
                            )
