...
export default function Main() {
  ...
  return (
    <main className=" z-0 rootMain row-start-2 row-end-3 ">
        ...
        <div className=" w-full h-full lg:h-28 lg:pl-56  lg:top-[40%] relative flex flex-col lg:flex-row justify-center lg:justify-start items-center gap-10  ">
          ...
          <div className="text-l-12   pl-5 md:pl-0   font-extrabold flex flex-col justify-center items-center lg:items-start gap-4 ">
            ...
            <div className="h-10 flex flex-row  d-TextShadow">
              <h2
                className="text-5xl   text-l-vert-11  dark:text-d-vert-12 "
                ref={textEditorRef}
              ></h2>
              <div className="text-5xl text-l-blue-12 dark:text-d-blue-12 ">
                |
              </div>
            </div>
          </div>
      ...
      <div
        ref={AboutDiv}
        className="show bg-transparent w-full h-full row-start-2 row-end-3 flex flex-row justify-around items-start "
      >
        <div ref={About} className="  h-[70vh] min-h-[550px] w-[600px]  bg-transparen  rounded-xl  overflow-hidden shadow-md  ">
          <img 
            className=" bg-cover bg-center bg-transparent "
        ...
        <div className="h-[70vh] w-[45%]   rounded-lg  flex flex-col justify-start items-start gap-6   ">
          ...
          <div className="w-2/3 h-fit  flex  items-end  justify-end">
            <a
              id={navEN[1]}
              className="mr-5 active:animate-click hover:scale-110 hover:rounded-xl ease-in duration-75  transition-all  cursor-pointer w-24 h-12 flex justify-center items-center rounded-lg  bg-l-blue-7 dark:bg-d-blue-4 text-xl text-l-blue-12 dark:text-d-blue-12 border  border-d-blue-3 dark:border-d-blue-10 "
            >
              MyCV
            </a>
          </div>
