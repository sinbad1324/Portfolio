...
export const SkillBtns = ({ col, row, title }) => {
    ...
    function melanger() {
        let text = "12345678990qwetzuioiplkjhgfddasyxcvbnnmQWERTZUIOPLKJHGFDDASrtzuioiplkjtzuioiplkjhgfddasyxcvbnnmQWERTZUIOPLKJHGFDDAShgfddasyxcvbnnmQWERTZUIOPtzuioiplkjhgfddasyxcvbnnmQWERTZUIOPLKJHGFDDASLKJHGFDDASYXCVVBNM"
    ...
    return (
        <div
            ...
            className={`border-2 relative  border-l-vert-8 dark:border-d-vert-8 w-[320px] h-[200px] col-start-${col} col-end-${col + 1} row-start-${row} row-end-${row + 1} `} >
            ...
            <div className="group h-full w-full flex justify-center items-center" >
                ...
                <div
                    className=" pointer-events-none absolute  top-5 left-8 w-[80%] h-[80%] bg-transparent rounded-xl  flex flex-col justify-center items-center">
